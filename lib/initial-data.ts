  ...
  services: [
    {
      ...
      desc_es: 'Diseño y desarrollo de sitios web modernos, rápidos y optimizados para conversión.',
      desc_en: 'Design and development of modern, fast websites optimized for conversion.',
    ...
    },
    {
      ...
      desc_es: 'Desarrollo de apps nativas y multiplataforma con interfaces intuitivas.',
      desc_en: 'Development of native and cross-platform apps with intuitive interfaces.',
    ...
    },
    {
      ...
      desc_en: 'Creation of unique and memorable visual identity for your brand.',
    ...
    },
    {
      ...
      desc_es: 'Estrategia y contenido para tus redes sociales que genera engagement.',
      desc_en: 'Strategy and content for your social media that generates engagement.',
    ...
    },
    {
      ...
      desc_es: 'Diseño profesional de tarjetas que dejan una impresión duradera.',
  ...
  projects: [
    {
      ...
      title_es: 'Proyecto 1',
      title_en: 'Project 1',
      desc_es: 'Trabajo destacado con enfoque en detalles, acabado limpio y una presentación elegante del resultado.',
      desc_en: 'Featured work focused on details, clean finish and elegant presentation of the result.',
      location: 'Quito',
      featured: true,
    ...
    },
    {
      ...
      location: 'Cuenca',
      featured: true,
      cover_image: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=800&h=600&fit=crop',
      gallery_images: [],
      status: 'publish',
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString()
    },
    {
      ...
      location: 'Quito',
      featured: true,
      cover_image: 'https://images.unsplash.com/photo-1519681393784-d120267933ba?w=800&h=600&fit=crop',
      gallery_images: [],
      status: 'publish',
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString()
    },
    {
      ...
      location: 'Ambato',
      featured: true,
      cover_image: 'https://images.unsplash.com/photo-1433086966358-54859d0ed716?w=800&h=600&fit=crop',
      gallery_images: [],
      status: 'publish',
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString()
    },
    {
      ...
      location: 'Cuenca',
      featured: true,
      cover_image: 'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?w=800&h=600&fit=crop',
      gallery_images: [],
      status: 'publish',
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString()
